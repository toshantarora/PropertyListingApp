...
public class AddKothiActivity extends AppCompatActivity
{
    private static final String TAG = "AddKothiActivity";

    private TextInputLayout textInputSellerName, textInputContactNumber, textInputPropertyAddress, textInputAskPrice;
    private Spinner spinnerCity;
    private Button btnSubmitKothi;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_add_kothi);
    ...
    private void submitKothi()
    {
                ...
                !askPrice.matches(""))
        {
            ...
            else
            {
                ...
                AddKothi kothi = new AddKothi(sellerName, propertyAddress, city, sector, condition, storey, sBasement, sForSale, contactNumber, price);
                long check = db.newKothi(kothi);
                if(check > 0) {
    ...
    private void initViews()
    {
        ...
        btnSubmitKothi = findViewById(R.id.btnSubmitKothi);
    ...
    {
        btnSubmitKothi.setOnClickListener(v -> {
            submitKothi();
        });
