...
public class AddPropertyDialog extends DialogFragment
{
    ...
    {
        View view = getActivity().getLayoutInflater().inflate(R.layout.dialog_add_property, null);
    ...
    private void executeIntentOnOptionSelect(int position)
    {
        switch (position)
        {
            case 1: // On select: Society Flat
                Intent sf = new Intent(getActivity(), AddSocietyActivity.class);
                startActivity(sf);
                dismiss();
                break;
            case 2: // On select: HousingBoard Flat
                Intent hb = new Intent(getActivity(), AddHousingBoardActivity.class);
                startActivity(hb);
                dismiss();
                break;
            case 3: // On select: Kothi
                Intent intent = new Intent(getActivity(), AddKothiActivity.class);
                startActivity(intent);
                dismiss();
                break;
            case 4: // On select: Sco
                Intent sco = new Intent(getActivity(), AddScoActivity.class);
                startActivity(sco);
                dismiss();
                break;
            case 5: // On select: Booth
                Intent b = new Intent(getActivity(), AddBoothActivity.class);
                startActivity(b);
                dismiss();
                break;
            default:
